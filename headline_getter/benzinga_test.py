...
class Benzinga:
    """
    Wrapper for Benzinga API calls/methods. 
    """
    ...
    def query_articles(start_date: datetime, end_date: datetime, limit: int or None = None) -> Tuple[pd.DataFrame, List[str]]:
        ...
        while cur_start_date.strftime(DATE_FORMAT) != cur_end_date.strftime(DATE_FORMAT):
            ...
            articles = Benzinga.query_articles_helper(cur_start_date, cur_end_date, News)
        ...
        articles_df, unique_stocks = Benzinga.convert_articles_to_df(all_articles)
